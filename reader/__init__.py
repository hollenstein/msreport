...
class MQReader(ResultReader):
    ...
    Attributes:
        filenames: (class attribute) Look up of filenames for the result files
...
class FPReader(ResultReader):
    ...
    Attributes:
        filenames: (class attribute) Look up of filenames
            for the result files generated by FragPipe.
