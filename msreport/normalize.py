...
class FixedValueNormalizer(BaseSampleNormalizer):
    ...
    def __init__(self, center_function: Callable, comparison: str):
        ...
        Args:
            ...
            comparison: Must be "paired" or "reference". When "paired" is specified
                ...
                an optimal normalizaion value for each column is calculated by solving
                a matrix of linear equations of the column pair values with least
                squares. When "reference" is selected, a pseudo-reference samples is
    ...
    def _fit_with_paired_samples(self, table: pd.DataFrame) -> None:
        ...
        normalizaion value for each column is calculated by solving a matrix of linear
    ...
    def _fit_with_pseudo_reference(self, table: pd.DataFrame) -> None:
        """Fits the FixedValueNormalizer by comparing colums to a pseudo-reference.
    ...
    def __init__(self, fit_function: Callable):
        ...
        Args:
            fit_function: A function that accepts a sequence of values and returns numpy
                array with two columns. The first column must contain the values and the
